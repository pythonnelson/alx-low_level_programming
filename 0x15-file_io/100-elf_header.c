 ...
 * @e_ident: The pointer to an array containing the ELF magic numbers.
 *
 * Description: This is the magic numbers are separated by spaces.
 */
void print_magic(unsigned char *e_ident)
{
	int index;
 ...
 * @e_ident: The pointer of an array containing the ELF ABI version.
 */
void print_abi(unsigned char *e_ident)
{
...
/**
 * print_entry - This rints the entry point of an ELF header.
 ...
 * 		the function fails - then exit code is 98.
 */
